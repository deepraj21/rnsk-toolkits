...
export default defineToolkit({
  id: 'aws',
  displayName: 'AWS',
  shortDescription: 'Manage EC2, VPC, S3, Lambda, DynamoDB, SQS/SNS, IAM, ECS/EKS/ECR, RDS, ElastiCache, EBS, Route53, CloudFront, API Gateway, Auto Scaling, EventBridge, VPC Lattice, CloudFormation, CodeBuild/Deploy/Pipeline, CodeArtifact, CloudTrail, X-Ray; monitor CloudWatch.',
