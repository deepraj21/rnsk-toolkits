import { tool } from 'ai';
import { z } from 'zod';
import { CreateClusterCommand } from '@aws-sdk/client-eks';
import { createEksClient } from '../client.js';

export const awsCreateEksCluster = tool({
  ...
  inputSchema: z.object({
    ...
    encryptionConfig: z.array(z.record(z.any())).optional().describe('Encryption configuration'),
