import { tool } from 'ai';
import { z } from 'zod';
import { GetCachePolicyCommand } from '@aws-sdk/client-cloudfront';
import { createCloudFrontClient } from '../client.js';

export const awsGetCloudfrontCachePolicy = tool({
  ...
  execute: async ({ awsCredentials, region, id }) => {
    ...
    try {
      ...
      return { error: 'Failed to get information about a CloudFront cache policy', message: err instanceof Error ? err.message : 'Unknown error' };
    }
  },
});
