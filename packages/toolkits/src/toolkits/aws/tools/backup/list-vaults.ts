import { tool } from 'ai';
import { z } from 'zod';
import { ListBackupVaultsCommand } from '@aws-sdk/client-backup';
import { createBackupClient } from '../client.js';

export const awsListBackupVaults = tool({
  ...
  inputSchema: z.object({
    ...
    maxResults: z.number().optional().describe('Maximum number of vaults to return'),
  }),
