...
export const awsPutS3BucketMetrics = tool({
  ...
  inputSchema: z.object({
    ...
    metricsConfiguration: z.record(z.any()).describe('Metrics configuration'),
  }),
  execute: async ({ awsCredentials, region, bucket, metricsConfiguration }) => {
    if (!awsCredentials) {
